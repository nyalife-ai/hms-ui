      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <Table headers={["Name", "Employee ID", "Role", "Department", "Status", ""]}>
            {staff.map((s) => (
              <tr key={s.id} className="transition hover:bg-surface-200/60">
                ...
                <td className="px-5 py-3.5 text-foreground-light">{s.employeeId}</td>
                <td className="px-5 py-3.5 text-foreground-light">{s.role}</td>
                <td className="px-5 py-3.5 text-foreground-light">{s.department}</td>
                <td className="px-5 py-3.5">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={() => setEdit(null)} className="rounded-lg p-1 text-foreground-lighter hover:bg-surface-200">
                <X className="h-4 w-4" />
              </button>
            </div>
            <div className="space-y-3">
